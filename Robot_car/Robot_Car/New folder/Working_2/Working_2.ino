 #define in1 2              // input 1  pin
#define in2 3              // input 2  pin
#define en_right 5         // right motor speed controller pin
#define en_left 6          // left motor speed controller  pin
#define in3 4               // input 3  pin
#define in4 7               // input 4  pin
#define sen_right 8         // right sensor input pin
#define sen_left 9          // left sensor input pin
#define high_speed 58      // speed of the motor in the OUTSIDE of the turn
